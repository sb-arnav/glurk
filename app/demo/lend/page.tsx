          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                {userData?.txSig && (
                  <a href={`https://explorer.solana.com/tx/${userData.txSig}?cluster=devnet`} target="_blank" rel="noopener noreferrer" className="text-[10px] font-mono text-emerald-400/50 hover:text-emerald-400 transition-colors">
                    consent tx ↗
                  </a>
                )}
              </div>
